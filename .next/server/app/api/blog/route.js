"use strict";(()=>{var e={};e.id=342,e.ids=[342],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},4651:(e,a,t)=>{t.r(a),t.d(a,{headerHooks:()=>f,originalPathname:()=>w,patchFetch:()=>v,requestAsyncStorage:()=>u,routeModule:()=>g,serverHooks:()=>h,staticGenerationAsyncStorage:()=>m,staticGenerationBailout:()=>b});var i={};t.r(i),t.d(i,{GET:()=>d,POST:()=>p});var r=t(5419),o=t(9108),n=t(9678),s=t(8070),l=t(6197),c=t(7048);async function d(e){try{var a,t;let{searchParams:i}=new URL(e.url),r={page:parseInt(i.get("page")||"1"),limit:parseInt(i.get("limit")||"10"),tag:i.get("tag")||void 0,search:i.get("search")||void 0,sortBy:(a=i.get("sortBy"),"views"===a||"likes"===a?a:"createdAt"),sortOrder:(t=i.get("sortOrder"),"asc"===t?"asc":"desc")},o=l.Qw.filter(e=>e.isPublished);r.search&&(o=(0,c.J$)(o,r.search)),r.tag&&(o=(0,c.B7)(o,r.tag)),o=(0,c.IY)(o,r.sortBy,r.sortOrder);let n=(0,c.fI)(o,r.page,r.limit);return s.Z.json({success:!0,data:{posts:n.items,totalCount:n.totalCount,currentPage:n.currentPage,totalPages:n.totalPages,hasNextPage:n.hasNextPage,hasPrevPage:n.hasPrevPage}})}catch(e){return console.error("Error fetching blog posts:",e),s.Z.json({success:!1,error:"Failed to fetch blog posts"},{status:500})}}async function p(e){try{let a=e.headers.get("authorization");if(!a||!a.startsWith("Bearer "))return s.Z.json({success:!1,error:"Unauthorized"},{status:401});let{title:t,description:i,content:r,tags:o,bannerImage:n,isPublished:c}=await e.json();if(!t||!i||!r)return s.Z.json({success:!1,error:"Missing required fields"},{status:400});let d={id:Date.now().toString(),title:t,slug:t.toLowerCase().replace(/[^a-z0-9 -]/g,"").replace(/\s+/g,"-"),description:i,content:r,tags:o||[],bannerImage:n||null,views:0,likes:0,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),isPublished:c||!1,readTime:Math.ceil(r.split(/\s+/).length/200),author:{name:"Maath Mphepo",avatar:"/images/author-avatar.jpg",bio:"Backend Developer specializing in Django and Laravel"}};return l.Qw.unshift(d),s.Z.json({success:!0,data:d},{status:201})}catch(e){return console.error("Error creating blog post:",e),s.Z.json({success:!1,error:"Failed to create blog post"},{status:500})}}let g=new r.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/blog/route",pathname:"/api/blog",filename:"route",bundlePath:"app/api/blog/route"},resolvedPagePath:"D:\\PROJ\\Maath_Mphepo\\src\\app\\api\\blog\\route.ts",nextConfigOutput:"standalone",userland:i}),{requestAsyncStorage:u,staticGenerationAsyncStorage:m,serverHooks:h,headerHooks:f,staticGenerationBailout:b}=g,w="/api/blog/route";function v(){return(0,n.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:m})}},6197:(e,a,t)=>{t.d(a,{Qw:()=>i,TV:()=>n,V0:()=>o,_A:()=>r});let i=[{id:"1",title:"Building Scalable APIs with Django REST Framework",slug:"building-scalable-apis-django-rest-framework",description:"Learn how to create robust, scalable APIs using Django REST Framework with best practices for authentication, serialization, and performance optimization.",content:`# Building Scalable APIs with Django REST Framework
...
Following these database design best practices will help you build robust, scalable applications that can grow with your business needs.`,tags:["Database","SQL","Performance","Backend"],bannerImage:"/images/blog/database-design-banner.jpg",views:890,likes:67,createdAt:"2024-01-05T09:15:00Z",updatedAt:"2024-01-05T09:15:00Z",isPublished:!0,readTime:10,author:{name:"Maath Mphepo",avatar:"/images/hero-profile.png",bio:"Backend Developer specializing in Django and Laravel"}}],r=[{id:"1",blogId:"1",name:"John Developer",email:"john@example.com",content:"Great article! The Django REST Framework examples are very helpful. I've been struggling with API authentication, and your explanation cleared things up.",isApproved:!0,createdAt:"2024-01-16T08:30:00Z"},{id:"2",blogId:"1",name:"Sarah Smith",email:"sarah@example.com",content:"Thanks for sharing this. Could you write a follow-up article about implementing JWT authentication with DRF?",isApproved:!0,createdAt:"2024-01-17T14:20:00Z"},{id:"3",blogId:"1",name:"Maath Mphepo",email:"maath@example.com",content:"Thanks for the suggestion, Sarah! JWT authentication with DRF is definitely on my list for upcoming articles.",parentId:"2",isApproved:!0,createdAt:"2024-01-17T15:45:00Z"}],o=[{id:"1",blogId:"1",type:"like",userIdentifier:"user1",createdAt:"2024-01-16T10:00:00Z"},{id:"2",blogId:"1",type:"clap",userIdentifier:"user2",createdAt:"2024-01-16T11:00:00Z"},{id:"3",blogId:"2",type:"like",userIdentifier:"user1",createdAt:"2024-01-11T09:00:00Z"}],n=[{id:"1",name:"Django",slug:"django",count:2},{id:"2",name:"Laravel",slug:"laravel",count:1},{id:"3",name:"Python",slug:"python",count:2},{id:"4",name:"PHP",slug:"php",count:1},{id:"5",name:"API",slug:"api",count:1},{id:"6",name:"Backend",slug:"backend",count:3},{id:"7",name:"Database",slug:"database",count:1}]},7048:(e,a,t)=>{function i(e){let a=new Map,t=[];return e.forEach(e=>{a.set(e.id,{...e,replies:[]})}),e.forEach(e=>{let i=a.get(e.id);if(e.parentId){let t=a.get(e.parentId);t&&(t.replies=t.replies||[],t.replies.push(i))}else t.push(i)}),t}function r(e,a){if(!a.trim())return e;let t=a.toLowerCase();return e.filter(e=>e.title.toLowerCase().includes(t)||e.description.toLowerCase().includes(t)||e.tags.some(e=>e.toLowerCase().includes(t))||e.content.toLowerCase().includes(t))}function o(e,a){return a?e.filter(e=>e.tags.some(e=>e.toLowerCase()===a.toLowerCase())):e}function n(e,a,t="desc"){return[...e].sort((e,i)=>{let r=0;switch(a){case"createdAt":r=new Date(e.createdAt).getTime()-new Date(i.createdAt).getTime();break;case"views":r=e.views-i.views;break;case"likes":r=e.likes-i.likes}return"desc"===t?-r:r})}function s(e,a,t){let i=(a-1)*t,r=i+t;return{items:e.slice(i,r),totalCount:e.length,currentPage:a,totalPages:Math.ceil(e.length/t),hasNextPage:r<e.length,hasPrevPage:a>1}}t.d(a,{B7:()=>o,IY:()=>n,J$:()=>r,T9:()=>i,fI:()=>s})}};var a=require("../../../webpack-runtime.js");a.C(e);var t=e=>a(a.s=e),i=a.X(0,[638,206],()=>t(4651));module.exports=i})();