import { BlogPost, Comment, BlogReaction, BlogTag } from '@/types/blog'
...
export const mockBlogPosts: BlogPost[] = [
  {
    ...
    description: 'Learn how to create robust, scalable APIs using Django REST Framework with best practices for authentication, serialization, and performance optimization.',
...
Django REST Framework provides all the tools needed to build production-ready APIs. By following these best practices, you can create APIs that scale with your application's growth.`,
    tags: ['Django', 'Python', 'API', 'Backend'],
    bannerImage: '/images/blog/django-api-banner.jpg',
    views: 1250,
    likes: 89,
  ...
  {
    id: '2',
    title: 'Laravel vs Django: A Comprehensive Comparison',
    slug: 'laravel-vs-django-comprehensive-comparison',
    description: 'An in-depth comparison of Laravel and Django frameworks, covering performance, ecosystem, learning curve, and use cases to help you choose the right framework.',
    content: `# Laravel vs Django: A Comprehensive Comparison
...
- Ecosystem preferences`,
    tags: ['Laravel', 'Django', 'PHP', 'Python', 'Comparison'],
    bannerImage: '/images/blog/laravel-django-banner.jpg',
    views: 2100,
    likes: 156,
  ...
  },
  {
    ...
    description: 'Essential database design principles and best practices for building efficient, scalable web applications with proper normalization and indexing strategies.',
    content: `# Database Design Best Practices for Web Applications
...
Following these database design best practices will help you build robust, scalable applications that can grow with your business needs.`,
    tags: ['Database', 'SQL', 'Performance', 'Backend'],
    bannerImage: '/images/blog/database-design-banner.jpg',
    views: 890,
    likes: 67,
...
export const mockComments: Comment[] = [
  {
    ...
    content: 'Great article! The Django REST Framework examples are very helpful. I\'ve been struggling with API authentication, and your explanation cleared things up.',
    isApproved: true,
  ...
  },
  {
    ...
    content: 'Thanks for sharing this. Could you write a follow-up article about implementing JWT authentication with DRF?',
    isApproved: true,
  ...
  },
  {
    ...
    content: 'Thanks for the suggestion, Sarah! JWT authentication with DRF is definitely on my list for upcoming articles.',
    parentId: '2',
    isApproved: true,
...
export const mockReactions: BlogReaction[] = [
  { id: '1', blogId: '1', type: 'like', userIdentifier: 'user1', createdAt: '2024-01-16T10:00:00Z' },
  { id: '2', blogId: '1', type: 'clap', userIdentifier: 'user2', createdAt: '2024-01-16T11:00:00Z' },
  { id: '3', blogId: '2', type: 'like', userIdentifier: 'user1', createdAt: '2024-01-11T09:00:00Z' }
]

export const mockTags: BlogTag[] = [
  { id: '1', name: 'Django', slug: 'django', count: 2 },
  { id: '2', name: 'Laravel', slug: 'laravel', count: 1 },
  { id: '3', name: 'Python', slug: 'python', count: 2 },
  { id: '4', name: 'PHP', slug: 'php', count: 1 },
  { id: '5', name: 'API', slug: 'api', count: 1 },
  { id: '6', name: 'Backend', slug: 'backend', count: 3 },
  { id: '7', name: 'Database', slug: 'database', count: 1 }
]
